...
## Tuning Parameters
We tuned at fit 9 models in our exploration. Aside from the null model, we added additional parameters to our other models to further improve their performance. Here are the parameters used and their outcomes:
