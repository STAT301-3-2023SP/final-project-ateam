...
log_reg_tictoc_rel <- tibble(model = time_log[[1]]$msg,
                             runtime = time_log[[1]]$toc - time_log[[1]]$tic)

save(log_reg_tune_rel, log_reg_tictoc_rel, file = "results/tuning_log_reg_rel.rda")
