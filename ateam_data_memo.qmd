...
## Assessment Measures
The assessment measures we chose to test model performance are accuracy, F1-Score, and a confusion matrix. 

* Accuracy: accuracy measures the proportion of correctly classified predictions over the total number of predictions 

* F1-Score: the F1-Score calculates the harmonic mean of precision and recall by combining them into one single measurement. It produces a comprehensive evaluation of the model's performance
...
## Model Performance
**Model won't run on my computer rn -- chose boost and null to run
